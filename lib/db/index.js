...
const serviceHost = process.env.MYDB_RDSDATABASE_CONFIGMAP_DB_HOST || 'localhost';
const servicePort = process.env.MYDB_RDSDATABASE_CONFIGMAP_DB_PORT || '5432';
const user = process.env.MYDB_RDSDATABASE_SECRET_DB_USERNAME || 'user';
const password = process.env.MYDB_RDSDATABASE_SECRET_DB_PASSWORD || 'password';
const dbName = process.env.MYDB_RDSDATABASE_DBNAME || 'my_data'
